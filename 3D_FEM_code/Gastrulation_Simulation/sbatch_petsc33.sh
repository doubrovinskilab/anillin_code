...
#SBATCH --output=log33.out
#SBATCH --error=log33.out
...
mpirun ./Petsc_IBM_Solver -in InputFiles/InputFile_33.txt -pc_type cholesky -use_stokes_pc -ksp_type minres -pc_factor_mat_solver_type mumps -recalculate_mat 50 -write_fluid_info 1 -write_solid_extra_info #-check_symmetry_A
